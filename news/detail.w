...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/model/model" xid="model" style="height:auto;left:246px;top:134px;"
    onLoad="modelLoad">
    <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="detail" idColumn="FID" onCustomRefresh="detailCustomRefresh" limit="20">
    	  <column label="ID" name="FID" type="Integer" xid="xid8"></column>
  <column label="添加时间" name="fAddTime" type="String" xid="xid9"></column>
  <column label="标题" name="fTitle" type="String" xid="xid10"></column>
  <column label="内容" name="fContent" type="String" xid="xid11"></column>
  <column label="已阅次数" name="fNumber" type="Integer" xid="xid12"></column>
  <column label="封面图片" name="fImage" type="String" xid="xid13"></column></div>
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-card x-has-iosstatusbar"> 
    <div class="x-panel-top" height="49"> 
      <div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar"> 
        ...
        <div class="x-titlebar-right reverse text-white"> 
          <a class="pull-right">
        <span bind-click="postClick" class="badge" bind-text=' $model.detail.val("fNumber")  +  "跟贴"'><![CDATA[]]></span></a></div> 
      </div> 
    </div>  
    <div class="x-panel-content x-cards panel-body"> 
      ...
      <div class="h6 text-muted"> 
        ...
        <span bind-text=' $model.detail.val("fAddTime")'>10-12 09：31</span> 
      </div>  
      <div class="h6">
        <img alt="" class="img-responsive" bind-attr-src="detail.ref('fImage')"/>
      </div>
      <div class="text-black lead" bind-html=' $model.detail.val("fContent")'>
      </div>  
      <div class="h5">
        <span><![CDATA[来源：]]></span>  
