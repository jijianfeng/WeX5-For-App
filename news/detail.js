define(function(require){
	...
	Model.prototype.postDataCustomRefresh = function(event){
        ...
        $.ajax({
            type: "GET",
            url: require.toUrl('http://42.96.159.122:8080/WeX5/mobile/comment_list?type=0&commentId='+id),
            dataType: 'json',
            async: false,
            cache: false,
	...
	Model.prototype.detailCustomRefresh = function(event){
        ...
        $.ajax({
            type: "POST",
            url: require.toUrl('http://42.96.159.122:8080/WeX5/mobile/news_detail?id='+id),
            dataType: 'json',
            async: false,
            cache: false,
            success: function(data){
