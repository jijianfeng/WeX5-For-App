...
<div xmlns="http://www.w3.org/1999/xhtml" class="main13" component="$UI/system/components/justep/window/window"
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full x-has-iosstatusbar"
   ...
   <span xid="span1"><![CDATA[我参加的活动]]></span></div>
      ...
      <div component="$UI/system/components/justep/panel/panel" class="panel panel-default x-card"> 
        <ul xid="ul1"> 
        <li class="list-group-item" xid="li1" bind-click="infoClick"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right"
            ...
            <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon"
              icon="icon-edit" xid="button17"> 
              <i xid="i30" class="text-danger icon-edit"/>  
              <span xid="span24"/> 
            </a>  
            <span xid="span22"><![CDATA[开发商信息]]></span> 
          </li>
          <li class="list-group-item" xid="li1" bind-click="jobIPub"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right"
              label="button" xid="button16" icon="icon-ios7-arrow-right" onClick="jobIPub"> 
              <i xid="i29" class="icon-ios7-arrow-right text-muted"/>  
              <span xid="span23"/> 
            </a>  
            <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon"
              icon="icon-android-calendar" xid="button17"> 
              <i xid="i30" class="text-danger icon-android-calendar"/>  
              <span xid="span24"/> 
            </a>  
            <span xid="span22"><![CDATA[我发布的职位]]></span> 
          </li> 
          <li class="list-group-item" xid="li1" bind-click="peopleGotten"> 
            <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon pull-right"
            ...
            <a component="$UI/system/components/justep/button/button" class="btn btn-link btn-only-icon"
              icon="icon-android-hand" xid="button15"> 
              <i xid="i28" class="icon-android-hand"/>  
              <span xid="span21"/> 
            </a>  
            <span xid="span19"><![CDATA[我招纳的人才]]></span> 
          </li>  
          </ul> 
      </div>  
      <!-- <div component="$UI/system/components/justep/panel/panel" class="panel panel-default x-card"> 
