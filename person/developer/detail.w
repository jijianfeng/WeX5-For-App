  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel3">
   ...
   <div xid="div3" class="m-div3">
    <div xid="div5" class="m-jobDetail-imgBox">
     <img src="" alt="" xid="image1" style="height:56px;width:63px;" bind-attr-src=' $model.singleJob.val("imageUrl")'></img></div> 
    <p xid="p2" class="m-jobDetail-text" bind-text=' $model.singleJob.val("job_name")'><![CDATA[]]></p>
    <p xid="p3" class="m-jobDetail-text" bind-text=' $model.singleJob.val("publisher")'><![CDATA[]]></p></div> 
    ...
    <div component="$UI/system/components/justep/row/row" class="x-row m-row" xid="row1">
     ...
     <div class="x-col" xid="col2">
      <div xid="div9" class="m-col">
       <div component="$UI/system/components/justep/output/output" class="x-output m-text-center m-exp" xid="output4" bind-text='"工作经验"'></div><div component="$UI/system/components/justep/output/output" class="x-output m-text-center" xid="output3" bind-text='$model.singleJob.val("experience")'></div>
       </div> </div> 
   ...
   <span xid="span4" class="m-jobDetail-tag">弹性工作</span>
   <span xid="span8" class="m-jobDetail-tag">弹性工作</span>
   <span xid="span9" class="m-jobDetail-tag">弹性工作</span></div></div> 
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="开发商" xid="button1" icon="icon-android-contact">
    <i xid="i1" class="icon-android-contact"></i>
    <span xid="span16">开发商</span></a> 
   ...
   <a component="$UI/system/components/justep/button/button" class="btn btn-default" label="拒绝" xid="button3" icon="icon-android-close" onClick="refuse">
    <i xid="i3" class="icon-android-close"></i>
    <span xid="span15">拒绝</span></a> 
   <a component="$UI/system/components/justep/button/button" class="btn btn-default" xid="button4" icon="icon-navigate" onClick="getJob">
    <i xid="i4" class="icon-navigate"></i>
    <span xid="span12"><![CDATA[接受]]></span></a> </div></div></div></div>