...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel3">
   <div class="x-panel-top" xid="top4"><div component="$UI/system/components/justep/titleBar/titleBar" title="详情" class="x-titlebar" style="background-color:#EA413C;" xid="titleBar2">
   ...
   <div class="x-titlebar-title" xid="title3">详情</div>
  ...
  <a component="$UI/system/components/justep/button/button" class="btn btn-default" xid="button4" icon="icon-android-send" onClick="getOrNot">
   <i xid="i5" class="icon-android-send"></i>
   <span xid="span2"><![CDATA[取消招纳]]></span></a></div></div></div></div>