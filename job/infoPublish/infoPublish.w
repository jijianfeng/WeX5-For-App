...
<div component="$UI/system/components/justep/panel/panel" class="x-panel x-full" xid="panel1">
   <div class="x-panel-top" xid="top2" style="color:white;"><div component="$UI/system/components/justep/titleBar/titleBar" class="x-titlebar" xid="titleBar1" title="发布求职信息" style="color:white;">
   ...
   <div class="x-titlebar-title" xid="title1">发布求职信息</div> 
  ...
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30 m-edit-input-box" xid="labelEdit2">
   ...
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit m-fabuzhiwei-input" xid="input2" placeHolder="请输入理想职位"></input></div><div xid="div5" class="clearfix m-fabuzhiwei-list" bind-click="nianxinClick">
   <span xid="span13" class="m-fabuzhiwei-title"><![CDATA[期望年薪]]></span>
   ...
   <span xid="span7" class="m-fabuzhiwei-title"><![CDATA[个人特点]]></span>
   <span xid="span1" class="m-fabuzhiwei-choice">
   <i src="" alt="" xid="i3" class="icon-chevron-right m-fabuzhiwei-icon"></i></span></div>   
  <div xid="div7" class="clearfix m-fabuzhiwei-list" bind-click="desClick">
   <span xid="span15" class="m-fabuzhiwei-title"><![CDATA[个人简介]]></span>
  ...
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30 m-edit-input-box" xid="labelEdit27">
   <label class="x-label m-fabuzhiwei-label" xid="label29"><![CDATA[个人邮箱
]]></label>    
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit m-fabuzhiwei-input" xid="input25" placeHolder="请输入个人邮箱"></input></div>
  <div component="$UI/system/components/justep/labelEdit/labelEdit" class="x-label-edit x-label30 m-edit-input-box" xid="labelEdit1">
   ...
   <input component="$UI/system/components/justep/input/input" class="form-control x-edit m-fabuzhiwei-input" xid="input1" placeHolder="请输入现居地址"></input></div>
